...
#define  SYS_BLE_MODE_1M		BIT(0)
#define  SYS_2P4G_MODE			BIT(5)

typedef struct{
	unsigned char sys_2p4g_mode_chg_flg;
	unsigned char sys_ble_1m_chg_flg;
	unsigned char sys_ble_2m_chg_flg;
