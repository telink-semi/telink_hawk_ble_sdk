...
void battery_power_check(int minVol_mV)
{
	...
	//           =  adc_result * 4680 >>12
	//           =  adc_result * 295 >>8
	//	u16 vol = (adcValueAvg * 1180 * 8)>>13;//Unit:mV; ���ڲο���ѹ��׼��ʵ�ʵĲο���ѹΪ1.18V(Vref = 1.2V);*8 indicate 1/8 scaler
	u16 vol;
	...
	{
		vol  = (adcValueAvg * 295)>>8; ////vol = (adcValueAvg * 1180 * 8)>>13;//Unit:mV; ���ڲο���ѹ��׼��ʵ�ʵĲο���ѹΪ1.18V(Vref = 1.2V);*8 indicate 1/8 scaler
	}
